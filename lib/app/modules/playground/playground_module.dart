...
import 'package:masterclass_app/app/modules/playground/design_pattern/controller_pattern/pages/bmi_page.dart';
...
class PlaygroundModule extends Module {
  ...
  final List<ModularRoute> routes = [
    ...
    ChildRoute('/exercicio2', child: (_, args) => const BmiPage()),
  ];
}
